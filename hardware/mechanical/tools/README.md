...
Scripts que geram e verificam o modelo de implantação `SAILSAFE_concept_v6_3.step`.
...
python3 tools/build_concept_v6_3.py SAILSAFE_concept_v6_2.step SAILSAFE_concept_v6_3.step
python3 tools/verify_concept.py SAILSAFE_concept_v6_3.step
python3 tools/validate_occ.py SAILSAFE_concept_v6_3.step          # opcional
python3 tools/make_layout_svg.py SAILSAFE_concept_v6_3.step SAILSAFE_layout_v6_3.svg
```
